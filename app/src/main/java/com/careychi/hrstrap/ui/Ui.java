...
public final class Ui {
    ...
    /** Runtime-selected background palette. DisplayBackgroundPolicy configures these at startup. */
    ...
    /**
     * Applies only the background palette requested for LCD panels.
     * Action-button colors intentionally remain unchanged so controls retain their existing state cues.
     */
    public static synchronized void applyLcdPureBlackBackground(boolean enabled) {
        if (enabled) {
            BG = Color.BLACK;
            SURFACE = Color.BLACK;
